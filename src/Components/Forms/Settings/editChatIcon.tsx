...
const EditChatIcon = ({register, errors, chatBot}: Props) => {
  return (
    <div className='py-5 flex flex-col gap-5 items-start'>
        ...
        {chatBot?.icon ? (
            ...
            <div className='rounded-full cursor-pointer shadow-md w-20 h-20
            flex items-center justify-center bg-iridium'>
                <BotIcon />
            </div>
        )}
    </div>
