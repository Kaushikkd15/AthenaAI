...
import EditChatIcon from './editChatIcon'
import dynamic from 'next/dynamic'
import GreetingsMessage from './greetingsMessage'


const welcomeMessage = dynamic( () => import('./greetingsMessage').then((props) => props.default),
                       {
                        ssr:false,
                       }
                      )
...
const SettingsForm = ({ id, name, chatBot, plan }: Props) => {
    ...
    return (
      <form
        className="p-3 flex flex-col gap-8 pb-10"
